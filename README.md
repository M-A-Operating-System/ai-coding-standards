...
└── dev-instructions/           # The knowledge base for AI
    ├── master_instructions.md  # 🚀 ENTRY POINT: Persona & Workflow
...
2. Ensure that `dev-instructions/master_instructions.md` is accessible.
...
1. **Primary Instruction**: "Adopt the persona and standards defined in `dev-instructions/master_instructions.md`."
